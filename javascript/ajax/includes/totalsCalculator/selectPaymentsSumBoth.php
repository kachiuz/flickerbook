...
FROM weekly_payments_amount WHERE user_id = '$user_id' AND taxPeriodNr >= '$firstTaxPeriodOfYear' AND taxPeriodNr <= '$taxPeriodNumber' AND employer = '$employer' AND job_title = '$jobTitle'"; 
